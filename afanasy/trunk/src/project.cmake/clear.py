...
store = ['FindPostgreSQL.cmake','.svn','build.sh','build_ostype.sh','override.sh','override.cmd','clear.py','clear.cmd','CMakeLists.txt','win_build_msvc_pyaf.cmd','win_build_msvc.cmd']
