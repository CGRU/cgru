...
extern "C"
{
	...
	inline PGconn *PQconnectStartParams(const char *const *keywords, const char *const *values,
										int expand_dbname)
	{
		return 0x0;
	}
	...
	inline PGconn *PQconnectdbParams(const char *const *keywords, const char *const *values,
									 int expand_dbname)
	{
		return 0x0;
	}

	inline PGconn *PQsetdbLogin(const char *pghost, const char *pgport, const char *pgoptions,
...
#define PQsetdb(M_PGHOST, M_PGPORT, M_PGOPT, M_PGTTY, M_DBNAME)                                              \
	...
	inline PGresult *PQprepare(PGconn *conn, const char *stmtName, const char *query, int nParams,
							   const Oid *paramTypes)
	{
		return 0x0;
	}

	inline PGresult *PQexecPrepared(PGconn *conn, const char *stmtName, int nParams,
