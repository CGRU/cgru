...
FileWidget::FileWidget(QWidget *i_parent, afqt::Attr *i_attr, const QString &i_filesmask)
	: QWidget(i_parent), m_attr(i_attr), m_filesmask(i_filesmask)
{
...
{
	QString afile = QFileDialog::getOpenFileName(this, QString("Browse %1 File").arg(m_attr->getLabel()),
