...
class ListItems : public QWidget, public Receiver
{
  ...
  protected:
	...
	void addParam_Num(Item::EType i_type, const QString &i_name, const QString &i_label, const QString &i_tip,
					  int i_min = -1, int i_max = -1);
	void addParam_Str(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_MSI(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_MSS(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_REx(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_Tim(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_Hrs(Item::EType i_type, const QString &i_name, const QString &i_label,
					  const QString &i_tip);
	void addParam_MiB(Item::EType i_type, const QString &i_name, const QString &i_label, const QString &i_tip,
					  int i_min = -1, int i_max = -1);
	void addParam_GiB(Item::EType i_type, const QString &i_name, const QString &i_label, const QString &i_tip,
					  int i_min = -1, int i_max = -1);
	...
	inline void setParameterStrEscape(Item::EType i_type, const std::string &i_name,
	...
	ButtonPanel *addButtonPanel(Item::EType i_type, const QString &i_label, const QString &i_name,
								const QString &i_description, const QString &i_hotkey = "",
								bool i_dblclick = false, bool i_always_active = false);
