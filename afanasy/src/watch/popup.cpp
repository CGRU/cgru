...
Popup::Popup(const QString &i_title, const QString &i_msg, uint32_t i_state) : QWidget(Watch::getDialog())
{
	...
	// Placement:
	setGeometry(
		QStyle::alignedRect(Qt::RightToLeft, Qt::AlignTop, size(), qApp->screens()[0]->availableGeometry())
...
void Popup::closeEvent(QCloseEvent *event) { ms_popup = NULL; }
