...
void ItemMonitor::updateInfo(af::Monitor *i_monitor)
{
	...
	m_info_text += "<br>";
	m_info_text +=
		QString("<br>Launch Time: <b>%1</b>").arg(afqt::stoq(af::time2str(i_monitor->getTimeLaunch())));
	m_info_text +=
		QString("<br>Register Time: <b>%1</b>").arg(afqt::stoq(af::time2str(i_monitor->getTimeRegister())));
	if (i_monitor->getTimeActivity())
		m_info_text += QString("<br>Time Activity: <b>%1</b>")
						   .arg(afqt::stoq(af::time2str(i_monitor->getTimeActivity())));
...
void ItemMonitor::v_paint(QPainter *i_painter, const QRect &i_rect,
...
void ItemMonitor::v_setSortType(int i_type1, int i_type2)
{
	...
	switch (i_type1)
	{
		...
		case CtrlSortFilter::TTIMELAUNCHED: m_sort_int1 = time_launch; break;
		...
		case CtrlSortFilter::TENGINE: m_sort_str1 = engine; break;
		case CtrlSortFilter::TADDRESS: m_sort_str1 = address_str; break;
	...
	switch (i_type2)
	{
		...
		case CtrlSortFilter::TTIMELAUNCHED: m_sort_int2 = time_launch; break;
		...
		case CtrlSortFilter::TENGINE: m_sort_str2 = engine; break;
		case CtrlSortFilter::TADDRESS: m_sort_str2 = address_str; break;
...
void ItemMonitor::v_setFilterType(int i_type)
{
	...
	switch (i_type)
	{
		...
		case CtrlSortFilter::TENGINE: m_filter_str = afqt::qtos(engine); break;
		case CtrlSortFilter::TADDRESS: m_filter_str = afqt::qtos(address_str); break;
