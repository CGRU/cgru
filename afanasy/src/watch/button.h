...
class Button : public QWidget
{
  ...
  public:
	Button(const QString &i_label, const QString &i_name = QString(), const QString &i_tooltip = QString(),
		   bool i_dblclick = false, bool i_radio = false, int i_clicked_ms = 500);
	...
	inline void setEnabled(bool i_enabled)
	{
		if (i_enabled == m_enabled)
			return;
		m_enabled = i_enabled;
		repaint();
	}
