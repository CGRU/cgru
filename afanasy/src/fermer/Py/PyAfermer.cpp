...
int jobId(JobObject::Ptr self) { return self->m_job_id; }

QList<JobObject::Ptr> jobsAll()
{
...
QList<JobObject::Ptr> jobsSelected()
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
	QList<JobObject::Ptr> ret;
	for (afermer::JobObjectPtrIt it = m_manager->begin(); it != m_manager->end(); ++it)
...
QList<JobObject::Ptr> jobsFromName(const QString &name)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
	QList<JobObject::Ptr> ret;
	for (afermer::JobObjectPtrIt it = m_manager->begin(); it != m_manager->end(); ++it)
...
QList<JobObject::Ptr> jobsFromUser(const QString &user)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
	QList<JobObject::Ptr> ret;
	for (afermer::JobObjectPtrIt it = m_manager->begin(); it != m_manager->end(); ++it)
...
bool jobsPause(const QList<int> &i_ids)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobsStart(const QList<int> &i_ids)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobsStop(const QList<int> &i_ids)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobPause(JobObject::Ptr self)
{
	jobsPause(QList<int>({1, self->id()}));
	return true;
}

bool jobStart(JobObject::Ptr self)
{
	jobsStart(QList<int>({1, self->id()}));
	return true;
}

bool jobStop(JobObject::Ptr self)
{
	jobsStop(QList<int>({1, self->id()}));
	return true;
}

bool jobSetBladeMask(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetAnnotation(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetDependMask(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetOS(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetPostCommand(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetLifeTime(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetTasksErrorRetries(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetTasksMaxRunTime(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetErrorForgiveTime(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetMaxRunningTasks(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetMaxRunningTaskPerBlades(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetSlots(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetNeedMemory(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetNeedHdd(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetNeedPower(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetErrorAvoidHost(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetExcludeBladeMask(JobObject::Ptr self, const QString &i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool jobSetPriority(JobObject::Ptr self, int i_value)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
...
bool userSetAnnotate(UserObject::Ptr self, const QString &i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
	return m_manager->setAnnotate(QList<int>({1, self->id()}), i_value);
}

bool userSetMaxRunningTask(UserObject::Ptr self, int i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
	return m_manager->setMaxRunningTask(QList<int>({1, self->id()}), i_value);
}

bool userSetBladeMask(UserObject::Ptr self, const QString &i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
	return m_manager->setBladeMask(QList<int>({1, self->id()}), i_value);
}

bool userSetBladeExcludeMask(UserObject::Ptr self, const QString &i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
...
bool userSetTaskErrorRetries(UserObject::Ptr self, int i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
...
bool userSetJobsSolvingMethod(UserObject::Ptr self, UserTypeSolveJobs::Type i_value)
{
	UserObjectsManager::Ptr m_manager = UserObjectsManager::create();
...
QString jobLog(JobObject::Ptr self)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
	return m_manager->log(self->id());
}

QString jobInfo(JobObject::Ptr self)
{
	JobObjectsManager::Ptr m_manager = JobObjectsManager::create();
	return m_manager->info(self->id());
}

QList<BladeObject::Ptr> bladesAll()
{
...
BOOST_PYTHON_MODULE(afermer)
{
	...
	class_<JobObject, JobObject::Ptr, boost::noncopyable>("_JobObject", no_init)
	...
	class_<BladeObject, BladeObject::Ptr, boost::noncopyable>("_BladeObject", no_init)
	...
	class_<UserObject, UserObject::Ptr, boost::noncopyable>("_UserObject", no_init)
...
PyAfermer::~PyAfermer() { Py_Finalize(); }
...
void PyAfermer::run_String(QString &o_ret, const QString &pytxt)
{
	try
	{
		boost::python::handle<> ignored(PyRun_String(pytxt.toStdString().c_str(), Py_file_input,
