...
class TaskState : public QObject
{
  ...
  public:
	...
	static void declareQML() { qmlRegisterType<TaskState>("TaskStateEnums", 1, 0, "TaskState"); }
};
...
class BladeState : public QObject
{
  ...
  public:
	...
	static void declareQML() { qmlRegisterType<BladeState>("BladeStateEnums", 1, 0, "BladeState"); }
};
...
class JobState : public QObject
{
  ...
  public:
	...
	static void declareQML() { qmlRegisterType<JobState>("JobStateEnums", 1, 0, "JobState"); }
};
