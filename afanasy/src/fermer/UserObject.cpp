...
int UserObject::id() const { return m_id; }

QString UserObject::user_name() const { return m_user_name; }

void UserObject::update(const QString &user_name, int jobs_size, int tasks_size,
