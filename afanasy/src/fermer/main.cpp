...
int main(int argc, char *argv[])
{
	...
	{
		std::cerr << "AFERMER_QML_PATH not present or directory does not exist. Take directory from startup "
				  << std::endl;
		...
		{
			std::cerr << "QML directory (" << qml_app_path << ") not found. Exit" << std::endl;
			return 1;
		}
	}
	else
