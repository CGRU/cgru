...
QString General::version() const { return QString::fromStdString(PKG_VERSION); }

bool General::serverExist() const { return m_RLS->isConnected(); }
...
void General::app_exit() const { m_RLS->exit(); }
