...
void Af::write(Msg *msg) { v_readwrite(msg); }

void Af::read(Msg *msg) { v_readwrite(msg); }

void Af::v_readwrite(Msg *msg) { AFERROR("Af::readwrite: Not implemented.\n") }
...
void Af::v_stdOut(bool full) const { std::cout << v_generateInfoString(full) << std::endl; }
