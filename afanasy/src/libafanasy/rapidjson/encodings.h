...
/*! http://en.wikipedia.org/wiki/UTF-16
	...
	\note For in-memory access, no need to concern endianness. The code units and code points are represented
   by CPU's endianness. For streaming, use UTF16LE and UTF16BE, which handle endianness.
*/
...
/*! http://en.wikipedia.org/wiki/UTF-32
	...
	\note For in-memory access, no need to concern endianness. The code units and code points are represented
   by CPU's endianness. For streaming, use UTF32LE and UTF32BE, which handle endianness.
*/
...
{
	//! Take one Unicode codepoint from source encoding, convert it to target encoding and put it to the
	//! output stream.
	template <typename InputStream, typename OutputStream>
