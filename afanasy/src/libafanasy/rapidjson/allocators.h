...
concept Allocator {
	...
	// \param originalSize The current size in bytes. (Design issue: since some allocator may not book-keep
...
template <typename BaseAllocator = CrtAllocator> class MemoryPoolAllocator
{
  public:
	...
	*/
	...
	/*! The user buffer will be used firstly. When it is full, memory pool allocates new chunk with chunk
	   size.
