...
/*!
	\tparam Encoding The interpretation of encoding of the stream. Either UTF8, UTF16LE, UTF16BE, UTF32LE,
   UTF32BE.
...
template <typename CharType, typename InputByteStream> class AutoUTFInputStream
{
  ...
  private:
	...
	void DetectType()
	{
		...
		{
			case kUTF16LE:
			case kUTF16BE: RAPIDJSON_ASSERT(sizeof(Ch) >= 2); break;
			case kUTF32LE:
			case kUTF32BE: RAPIDJSON_ASSERT(sizeof(Ch) >= 4); break;
		}
	}
