...
MCGeneral::MCGeneral() : name(""), string(""), number(0), id(-1) {}

MCGeneral::MCGeneral(int32_t Number) : name(""), string(""), number(Number), id(-1) {}

MCGeneral::MCGeneral(const std::string &String) : name(""), string(String), number(0), id(-1) {}

MCGeneral::MCGeneral(const std::string &Name, int32_t Number) : name(Name), string(""), number(Number), id(-1)
{
}

MCGeneral::MCGeneral(const std::string &Name, const std::string &String)
	: name(Name), string(String), number(0), id(-1)
{
}

MCGeneral::MCGeneral(Msg *msg) { read(msg); }
