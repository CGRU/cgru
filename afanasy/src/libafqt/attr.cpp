...
Attr::Attr(const Attr &i_other) : name(i_other.name), label(i_other.label), str(i_other.str) {}

Attr::Attr(const QString &i_name, const QString &i_label, const QString &i_init)
	: name(i_name), label(i_label), str(i_init)
{
}
...
AttrNumber::AttrNumber(const AttrNumber &i_other) : Attr(i_other), n(i_other.n) {}

AttrNumber::AttrNumber(const QString &i_name, int i_init) : Attr(i_name, "", ""), n(i_init) {}

AttrNumber::AttrNumber(const QString &i_name, const QString &i_label, int i_init)
	: Attr(i_name, i_label, ""), n(i_init)
{
}
...
const QString AttrNumber::v_writeData() { return QString::number(n); }
