...
SysBlock_Events::SysBlock_Events(JobAf *blockJob, af::BlockData *blockData, af::JobProgress *progress)
	: SysBlock(blockJob, blockData, progress){AFINFO("SysBlock_WOL::SysBlock_WOL:")}
...
SysBlockData_Events::SysBlockData_Events(int BlockNum, int JobId) : SysBlockData(BlockNum, JobId)
{
