...
bool JobAf::reconnectTask(af::TaskExec & i_taskexec, RenderAf & i_render, MonitorContainer * i_monitoring)
{
	...
	return m_blocks[b]->reconnectTask( i_taskexec, i_render, i_monitoring);
}
