...
SysBlock_CmdPost::SysBlock_CmdPost(JobAf *blockJob, af::BlockData *blockData, af::JobProgress *progress)
	: SysBlock(blockJob, blockData, progress){AFINFO("SysBlock_CmdPost::SysBlock_CmdPost:")}
...
SysBlockData_CmdPost::SysBlockData_CmdPost(int BlockNum, int JobId) : SysBlockData(BlockNum, JobId)
{
