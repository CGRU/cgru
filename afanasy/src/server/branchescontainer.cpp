...
BranchSrv * BranchesContainer::addBranch(const std::string & i_path, MonitorContainer * i_monitors)
{
AF_DEBUG << i_path;
//Filter branch path
...
int BranchesContainer::addBranch(BranchSrv * i_branch)
{
