...
class MonitorContainer : public AfContainer
{
  public:
	...
	void outputsReceived(const std::vector<af::MCTaskPos> &i_outspos,
...
class MonitorContainerIt : public AfContainerIt
{
  public:
	...
	inline MonitorAf *getMonitor(int i_id, const af::Msg *i_msg = NULL)
	{
		return static_cast<MonitorAf *>(get(i_id, i_msg));
	}
