...
void HostRes::readwrite( Msg * msg)
{
      ...
      rw_uint32_t( mem_free_mb,      msg);
      rw_uint32_t( mem_cached_mb,    msg);
      rw_uint32_t( mem_buffers_mb,   msg);
      rw_uint32_t( swap_used_mb,     msg);
      rw_uint32_t( hdd_free_gb,      msg);
...
void Host::readwrite( Msg * msg)
{
   ...
   rw_uint32_t( cpu_num,      msg);
   rw_uint32_t( cpu_mhz,      msg);
   rw_uint32_t( mem_mb,       msg);
   rw_uint32_t( swap_mb,      msg);
   rw_uint32_t( hdd_gb,       msg);
   rw_QString ( os,           msg);
