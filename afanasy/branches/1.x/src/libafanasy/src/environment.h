...
/// Get Afanasy server QHostAddress.
   ...
   static inline const int      getFileNameSizeMax()  { return filenamesizemax; } ///< Get maximum size for filenames.
   ...
   static inline const int      get_DB_StringNameLen()  { return db_stringnamelen;} ///< Get database string name length.
   static inline const int      get_DB_StringExprLen()  { return db_stringexprlen;} ///< Get database string expression length.
