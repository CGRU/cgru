...
class meCheckTexturePaths(object):
    ...
    def onStrToFindChanged(self, value):
        self.strToFind = \
            maya_ui_proc.setDefaultStrValue(self_prefix, 'strToFind', None, value)

    def onStrToReplaceChanged(self, value):
        self.strToReplace = \
            maya_ui_proc.setDefaultStrValue(self_prefix, 'strToReplace', None, value)

    def onStrPrefixChanged(self, value):
        self.strPrefix = \
            maya_ui_proc.setDefaultStrValue(self_prefix, 'strPrefix', None, value)
