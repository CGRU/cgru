...
class meVRayRender(object):
    ...
    def initParameters(self):
        ...
        #
        self.vr_param['vr_reuse'] = getDefaultIntValue(self_prefix, 'vr_reuse',
                                                       1) is 1
        ...
        if not skipExport:
            ...
            if vr_deferred:
                ...
                for layer in renderLayers:
                    ...
                    saveMayaGlobals['renderableLayer'] = \
    ...
    def renderLayersSetup(self, layers):
        ...
        for layer in layers:
            if layer != 'defaultRenderLayer':
                ...
                cmds.scriptJob(
                    nodeNameChanged=[layer, 'import maya.OpenMaya; maya.cmds.evalDeferred("meVRayRender.renderLayerRenamed()" , lowestPriority = True)'],
                    parent=selector,
    ...
    def setupUI(self):
        ...
        self.winMain = cmds.window(meVRayRenderMainWnd,
                                   title='meVRayRender ver.%s (%s)' % (meVRayRenderVer, self.os),
                                   menuBar=True,
                                   retain=False,
                                   widthHeight=(420, 460))
