...
function suseArch(){
	...
	packages="$packages openexr-devel"
	packages="$packages libqt6-qtbase-devel"
	packages="$packages libqt6-qtmultimedia-devel"
	packages="$packages python3-qt6"
...
function altArch(){
	...
	packages="$packages git-core"
	packages="$packages python3-dev"
	packages="$packages python3-module-PyQt6"
	packages="$packages postgresql-devel"
	packages="$packages qt6-base-devel"
	packages="$packages libEGL-devel"
	packages="$packages qt6-multimedia-devel"
...
function mageiaArch(){
	...
	packages="$packages postgresql-devel"
	packages="$packages qt6-devel lib64qt6multimedia-devel"
	packages="$packages rpm-build"
	packages="$packages libzip libzip-devel"
...
function macosxArch(){
	...
	packages="$packages postgresql"
	packages="$packages qt6"
	packages="$packages python3"
	packages="$packages pyqt6"
