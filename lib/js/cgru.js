...
function cgru_Dialog( i_args)
{
	...
	if( this.info == null )
	{
		this.info = 'Enter "'+this.parameter+'"';
		switch( this.type)
		{
...
cgru_Dialog.prototype.apply = function()
{
	...
	this.receiver[this.handle]( value, this.parameter);
	this.destroy();
}
...
//	if(( i_name == null ) && ( this.elRoot.lastChild != null ))
	...
	el.name      = i_args.name;
	el.parameter = i_args.parameter == null ? i_args.name : i_args.parameter;
