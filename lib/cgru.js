...
function cgru_SetUserName( i_name)
{
	if( i_name == null ) return false;
	if( i_name.length == null ) return false;
	if( i_name.length == 0 ) return false;
	localStorage['user_name'] = i_name;
	cgru_params[0][0].innerHTML = i_name;
	return true;
}
