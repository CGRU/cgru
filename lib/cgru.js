...
{ 
	if( e.keyCode == 27 ) // Esc
		...
		this.apply();
	else if(( e.keyCode == 40 ) && ( this.type == 'num')) // Up
		this.elInput.textContent = (parseInt(this.elInput.textContent))+1;
	else if(( e.keyCode == 38 ) && ( this.type == 'num')) // Down
		this.elInput.textContent = (parseInt(this.elInput.textContent))-1;
}
