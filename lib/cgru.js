...
cgru_Menu.prototype.addItem = function( i_name, i_handle, i_title, i_enabled, i_parameter)
{
	...
	el.cgru_Menu = this;
	el.name = i_name;
	el.parameter = i_parameter ? i_parameter : i_name;
	el.handle = i_handle;
...
cgru_Menu.prototype.onMouseUpDown = function( evt)
{
	...
	el.cgru_Menu.reciever[el.handle]( el.parameter);
