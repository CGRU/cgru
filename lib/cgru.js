...
function cgru_Dialog( i_document, i_elParent, i_reciever, i_parameter, i_value, i_dialogname, i_title, i_info)
{
...
//	this.elRoot.appendChild( this.elInput);
	...
	if( i_value )
		this.elInput.innerHTML = i_value;
...
cgru_Dialog.prototype.apply = function()
{
	...
	this.reciever.cgru_Dialog( this.parameter, this.elInput.innerHTML);
	this.destroy();
}

function cgru_Menu( i_elParent, i_evt, i_reciever, i_handle, i_name)
{
	this.elParent = i_elParent;
	this.reciever = i_reciever;
...
cgru_Menu.prototype.onMouseUpDown = function( evt)
{
	...
	el.cgru_Menu.reciever[el.cgru_Menu.handle]( el.actionName);
