...
function cgru_Dialog( i_document, i_elParent, i_reciever, i_handle, i_parameter, i_value, i_dialogname, i_title, i_info)
{
...
{
	this.reciever[this.handle]( this.parameter, this.elInput.textContent);
	this.destroy();
}
